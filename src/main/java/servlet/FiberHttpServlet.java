...
public class FiberHttpServlet extends HttpServlet {
    ...
    @Override
    @Suspendable
    final public void service(final ServletRequest req, ServletResponse res) throws ServletException {
        ...
        final HttpServletRequest r = new FiberHttpServletRequest(this, request);
        new Fiber("http servlet", stackSize, new ServletSuspendableRunnable(this, ac, r, new FiberHttpServletResponse(response))).start();
    }
